...
export function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  const shareLinks = {
    ...
    email: `mailto:?subject=${encodedTitle}&body=Schau dir diesen Artikel an: ${encodedUrl}`,
  }
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-[#0088cc]/10 text-[#0088cc] hover:bg-[#0088cc] hover:text-white transition-colors"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-foreground/10 text-foreground hover:bg-foreground hover:text-background transition-colors"
        title="Auf X teilen"
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
